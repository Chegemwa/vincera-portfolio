  ...
  return (
    <main className="bg-[#0F0F0F] min-h-screen text-[#F5F5F5] font-sans">
      ...
      <section id="portfolio" className="px-6 md:px-16 py-16">
        ...
        <div className="flex flex-col md:flex-row gap-4 max-w-4xl mx-auto">
          <div className="bg-[#1A1A1A] rounded-xl overflow-hidden flex-1">
            <div className="bg-[#2A2A2A] h-48 flex items-center justify-center">
              <span className="text-[#9CA3AF] text-sm">Project Preview</span>
            </div>
            <div className="p-5">
